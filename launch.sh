...
cp docker-compose.yml ansible/playbook/docker-compose.yml
if [ $? -eq 0 ]; then
    echo "Étape 2: docker-compose.yml copié avec succès."
else
    echo "Échec de l'Étape 2: La copie de docker-compose.yml a échoué."
    exit 1
fi

export $(cat .env | xargs)
if [ $? -eq 0 ]; then
    echo "Étape 3: Variables d'environnement exportées avec succès."
else
...
echo "Étape 5: Planification de Terraform..."
...
echo "Étape 6: Application de Terraform..."
